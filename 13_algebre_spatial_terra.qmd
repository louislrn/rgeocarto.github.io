...
Les opérations zonales peuvent être réalisées par zone délimitée par les valeurs catégorielles d'un second raster avec la fonction `zonal()`. **Pour cela, les deux rasters doivent avoir exactement la même étendue et la même résolution**.
